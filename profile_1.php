...
<form id="registration-form" name="registration-form" class="register-form" action="process.php" method="post">
    ...
    <div class="content">
        <div>
        <!--USERNAME--><label for="username">User Name <span style="color: red;font-size: x-large;">*</span>: </label><input name="username" type="text" class="input username" placeholder="Username" 
                                                                       data-validation="alphanumeric required server" data-validation-allowing="-_"
                                                                       data-validation-url="validate-user.php"
                                                                      data-validation-error-msg="Username is empty or not valid"/><!--END USERNAME-->
        </div>
        <br/>
        <!--PASSWORD-->
        <div><label for="password">Password <span style="color: red;font-size: x-large;">*</span>: </label><input name="password" type="password" class="input password" placeholder="Password" data-validation="required" 
		 data-validation-error-msg="You did not enter a password"/>
            <div id="passwordStrengthDiv" class="is0" style="float: left;"></div></div>
        <!--END PASSWORD-->
        <br/>
        <!--PASSWORD CONFIRM-->
        <div><label for="password2">Repeat password <span style="color: red;font-size: x-large;">*</span>: </label><input name="password2" type="password" class="input password" placeholder="Password" data-validation="required"
        ...
        <br/>
        <!--FULLNAME-->
        <div><label for="fullname">Full Name <span style="color: red;font-size: x-large;">*</span>: </label><input name="fullname" type="text" class="input username" placeholder="Full Name" data-validation="custom" 
                                                                       data-validation-regexp="^([a-zA-Z]+)$" data-validation-error-msg="Full name is empty or not valid"/>
        </div>
            <!--END FULLNAME-->
            <br/>
        <!--ORGANIZATION-->
        <div><label for="organization">Organization: </label><input name="organization" type="text" class="input username" placeholder="Organization"/>
        </div><!--END ORGANIZATION-->
        <br/>
        <!--ADDRESS-->
        <div><label for="address">Address: </label><input name="address" type="text" class="input username" placeholder="Address"/>
        </div><!--END ADDRESS-->
        <br/>
        <!--ADDRESS2-->
        <div><label for="address2">&nbsp; </label><input name="address2" type="text" class="input username" placeholder="Address"/>
        </div><!--END ADDRESS2--><br/>
        <!--REGION-->
        <div><label for="region">Region/State: </label><input name="region" type="text" class="input username" placeholder="Region/State"/>
        </div><!--END REGION--><br/>
        <!--ZIP-->
        <div><label for="zip">Postal Code <span style="color: red;font-size: x-large;">*</span>: </label>
            <input name="zip" type="text" class="input username"  placeholder="Postal Code" data-validation="number" 
                   data-validation-error-msg="Postal code is empty or not valid" />
        </div><!--END ZIP--><br/>
        <!--COUNTRY-->
        ...
        <div><label for="phone">Phone <span style="color: red;font-size: x-large;">*</span>: </label>
            <input name="phone" type="text" class="input username"  
                    placeholder="Phone" data-validation="number" data-validation-error-msg="Phone number is empty or not valid"/>
        </div><!--END PHONE--><br/>
        <!--EMAIL-->
